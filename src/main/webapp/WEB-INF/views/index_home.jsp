                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">SkillRary</a>
                            <i class="brand_network"><small><small></small></small></i>
                        </div>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">skillrary is an IT Educational Institute.Established in 2001,and Institute offers world class quality of education and wide range of courses.skillrary Institute has a dedicated placement team to help students get job placement in various IT job roles with major companies.
	    </p>
		...
		<p><strong>E-Mail ID :</strong>  skillrary999@gmail.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2022 <a href="#"  target="_blank" class="w3-hover-text-green"> skillrary.com</a></p>
</footer>
